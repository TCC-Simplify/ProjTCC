        ...
        <div id="container" class="animar">
            ...
            <div class="form-group{{ $errors->has('email') ? ' has-error' : '' }}">
                <div class="label-float">
                    <input id="email" type="email" placeholder="Email:" name="email" value="{{ $request['email'] }}" required>
                    <label>E-mail</label>
            ...
            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                <div class="label-float">
                    <input id="password" type="password" placeholder="Senha:" name="password" required autofocus>
            ...
            <div class="form-group">
                <div id="div-botao">
                    <input type="submit" name="botao" value="Redefinir senha">
                </div>
            </div>
        </form>
        </div>
